...
- 24 posts published: the 15 cornerstone pillar pages (seq 1-15), plus seq 16-24 (9 money pages: conversion-rate-optimisation-services, conversion-rate-optimisation-consultant, conversion-rate-optimisation-uk, conversion-rate-optimisation-audit, crm-implementation-services, crm-implementation-consultant, crm-audit, fractional-sales-director, fractional-cro), all live in `site/services/`. `next_index` = 25, routine resumes at seq 25.
