...
- 45 posts published: the 15 cornerstone pillar pages (seq 1-15), seq 16-39 (money pages across CRO, CRM, fractional, growth, market entry, ecommerce, RevOps pillars in site/services/), plus 6 authority posts in site/blog/: seq 145 (what-is-conversion-rate-optimisation), seq 201 (what-is-a-good-conversion-rate), seq 355 (how-to-calculate-conversion-rate) published 2026-06-27; seq 356 (cac-and-ltv), seq 357 (crm-implementation-project-plan), seq 358 (fractional-revenue-leadership) published 2026-06-28. `next_index` = 359, routine resumes at seq 359.
- Netlify git continuous deployment is connected (push to main -> deploy). GA4 (G-3XWNSR5VHF) is live and consent-gated. Sitemap: https://thepearsonco.com/sitemap.xml (49 URLs, submit in GSC).
