...
- 96 posts published: the 15 cornerstone pillar pages (seq 1-15), seq 16-39 (money pages across CRO, CRM, fractional, growth, market entry, ecommerce, RevOps pillars in site/services/), plus 57 authority posts in site/blog/: seq 145, 201, 355 published 2026-06-27; seq 356-358 published 2026-06-28; seq 359-361 published 2026-06-29; seq 362-364 and seq 365-367 published 2026-07-01; seq 368-370 published 2026-07-02; seq 371-373 published 2026-07-03; seq 374-376 published 2026-07-04; seq 377-379 published 2026-07-05; seq 380-382 published 2026-07-06; seq 383-385 published 2026-07-07; seq 386-388 published 2026-07-08; seq 389-391 published 2026-07-09; seq 392-394 published 2026-07-10; seq 395-397 published 2026-07-11; seq 398-400 published 2026-07-12; seq 401-403 published 2026-07-13; seq 404-406 published 2026-07-14; seq 407 (salesforce-vs-zoho), seq 408 (crm-adoption-for-sales-teams), seq 409 (what-is-sales-pipeline-management) published 2026-07-15. `next_index` = 410, routine resumes at seq 410.
- Netlify git continuous deployment is connected (push to main -> deploy). GA4 (G-3XWNSR5VHF) is live and consent-gated. Sitemap: https://thepearsonco.com/sitemap.xml (100 URLs, submit in GSC).
- The publishing routine (Strategist + 8 souls) is running: 3 posts/run, pointer-based from `build_state.json`. Each new post's publish date is set to the actual run date, not a fixed date; confirmed again this run (15 July 2026 on all three new posts, both in the visible byline and the JSON-LD datePublished/dateModified). This has now been correct on every new post across thirteen consecutive runs (2-15 July). The June-16 date the client keeps flagging belongs only to 21 older published pages (front-loaded pillar/money pages and early authority posts from the 16-26 June period) that still carry a hardcoded "16 June 2026" (or other June) byline date predating this rule; this remains out of scope for this 3-post authority-only routine, which cannot fix it within its normal scope, and stays flagged as a standalone bulk backdate-correction job for the client to schedule separately (raised repeatedly now).
...
- Watch items: (1) salesforce-consultant (money page referenced by seq 407's up-link spec), crm-adoption-consulting (seq 408's target), customer-journey-mapping-service (seq 65), crm-automation-service (seq 96), sales-analytics-consulting (seq 104), uae-market-entry-service (seq 68), process-mapping-service (seq 85), sales-automation-service (seq 90), crm-selection-service (seq 54), sales-dashboard-service (seq 100), crm-consultant-for-startups (seq 122), crm-training-service (seq 123), b2b-gtm-strategy-service (seq 126), and the go-to-market pillar's money pages are still not-started; this run's three posts link only to their live pillar/money pages since some specified target pages are not yet live. (2) link_graph.py reports the full graph clean (96 pages, 0 issues) as of the twenty-seventh run; this run's three new posts were initially flagged as orphans, then fixed by adding an inbound Related-reading link from two sibling posts each (crm-vs-spreadsheet.html + crm-selection-criteria.html; crm-adoption-metrics.html + crm-adoption-plan.html; defining-pipeline-stages.html + healthy-sales-pipeline.html) before the graph reported clean. (3) At the start of the seventeenth run, a stale multi-ref `git fetch` briefly suggested `main` was 18 posts behind this session's branch; re-fetching confirmed `origin/main` already had all of them, so it was a false alarm, not an actual deploy gap. Always re-fetch a single ref to confirm before treating a branch-divergence reading as real.
