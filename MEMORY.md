...
- 39 posts published: the 15 cornerstone pillar pages (seq 1-15), seq 16-30 (CRO, CRM, fractional, growth, market entry, ecommerce, b2b-CRO, landing-page, CRO-strategy money pages), seq 31-33 (sales-funnel-optimisation, lead-management-setup, saas-conversion-rate-optimisation), seq 34-36 (sales-funnel-audit, revops-consulting, revops-consultant), plus seq 37-39 (revops-as-a-service, revops-strategy, saas-revenue-operations), all live in `site/services/`. `next_index` = 40, routine resumes at seq 40.
- Netlify git continuous deployment is connected (push to main -> deploy). GA4 (G-3XWNSR5VHF) is live and consent-gated. Sitemap: https://thepearsonco.com/sitemap.xml (43 URLs, submit in GSC).
