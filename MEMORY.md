...
- 18 posts published: the 15 cornerstone pillar pages (seq 1-15), plus the first 3 Conversion & Funnel Optimisation money pages (seq 16-18: services, consultant, UK), live in `site/services/`. `next_index` = 19, so the routine resumes at `conversion-rate-optimisation-audit`.
