...
- 42 posts published: the 15 cornerstone pillar pages (seq 1-15), seq 16-39 (money pages across CRO, CRM, fractional, growth, market entry, ecommerce, RevOps pillars in site/services/), plus 3 authority posts published 2026-06-27 in site/blog/ (seq 145: what-is-conversion-rate-optimisation, seq 201: what-is-a-good-conversion-rate, seq 355: how-to-calculate-conversion-rate). `next_index` = 356, routine resumes at seq 356.
- Netlify git continuous deployment is connected (push to main -> deploy). GA4 (G-3XWNSR5VHF) is live and consent-gated. Sitemap: https://thepearsonco.com/sitemap.xml (46 URLs, submit in GSC).
